...
//uart_printf("User_Time: %d cycles, %d insn\n", User_Time, 32422); //-03 RUNS 100
//uart_printf("User_Time: %d cycles, %d insn\n", User_Time, 39620); //-0 RUNS 100
 
 int Cycles_Per_Instruction_x1000 = (1000 * User_Time) / User_Insn;  
//int Cycles_Per_Instruction_x1000 = (1000 * User_Time) / 32422;//-03 RUNS 100
//int Cycles_Per_Instruction_x1000 = (1000 * User_Time) / 39620;//-0 RUNS 100
